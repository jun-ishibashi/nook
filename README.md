...
**NOOK** — 男一人暮らしの部屋づくりを中心の想像に、モノトーン・デスク・ガジェットなどのこだわりを写真から家具・雑貨の商品ページまでひと続き。インスピレーションと買うあいだを短くするフィード。（ターゲットの寄せ方・排他しない方針は [`docs/product-vision.md`](docs/product-vision.md) §6）
